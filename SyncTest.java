public class SyncTest {
	public static void main(String args[]) throws InterruptedException {
		...
		Account a2 = new Account(2,"Ramesh",170000f);
		Transaction t1 = new Transaction("Neeta",a1,5000); // a common object for all threads
		Transaction t2 = new Transaction("\tJulie",a1,7000);
		Transaction t3 = new Transaction("\t\tSaama",a1,80050);
		Transaction t4 = new Transaction("Saama",a2,8000);
		Transaction t5 = new Transaction("\t\t\tSaama",a2,18000);
...
class Account {
  ...
  private float bal;
	...
	void printBal() {
		System.out.println("Available Balance in "+accName+" account is "+bal);
	}
}
